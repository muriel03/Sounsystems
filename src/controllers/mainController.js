...
const controller = {
    ...
    newProduct: (req, res) => {
        ...
        .then(function([brandList, categoryList]){
            res.render('./products/newProduct', {brandList, categoryList, ...productInit})
        }).catch(error => {
            console.log(error);
        })
    },
    ...
    createProduct: async (req, res) => {
        ...
        if(resultValidations.errors.length > 0){
            ...
            res.render('./products/newProduct', {
                categoryList, brandList, ...req.body, errors: {...resultValidations.mapped()}
            });
            return;
        }else{
    ...
    editProduct: async (req, res) => {
        ...
        const [productToEdit, categoryList, brandList] = await Promise.all([products, category, brands]);
